...
def run():
    ...
    print("=" * 70)
    print("0) Garantindo que bovino_lactacoes.observacoes existe (defensivo)")
    print("=" * 70)
    cur.execute("ALTER TABLE bovino_lactacoes ADD COLUMN IF NOT EXISTS observacoes TEXT")
    conn.commit()
    log("OK")
