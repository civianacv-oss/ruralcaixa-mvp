...
ADICIONAR em app/main.py (mesmo padrão dos outros routers):
    administradores_router = None
    try:
        from app.routers.administradores import router as administradores_router
        print("ADMINISTRADORES ROUTER LOADED OK")
    except Exception as e:
        print(f"ADMINISTRADORES ROUTER FAILED: {e}")
        administradores_router = None
    if administradores_router: app.include_router(administradores_router)
"""
