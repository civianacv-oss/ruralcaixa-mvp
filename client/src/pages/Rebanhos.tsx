...
export default function Rebanhos() {
  ...
  const handleUpdate = () => {
    ...
    updateAnimal.mutate({
      ...
      peso_nascimento: form.peso_nascimento ? Number(form.peso_nascimento) : undefined,
      categoria: form.categoria || undefined,
      ...(especie === "bovino" ? { aptidao_manejo: form.aptidao_manejo || undefined } : {}),
    } as any);
  };
