          ...
          {produtor && (
            <>
                  ...
                  lancamentos.map(l => (
                    <div key={l.id} className="flex items-center justify-between py-2 border-b last:border-0">
                      <div>
                        ...
                        <div className="text-xs text-gray-400">{new Date(l.data_lancamento).toLocaleDateString("pt-BR")}</div>
                        {l.documento_url && (
              ...
              <div className="bg-white rounded-xl p-4 shadow-sm space-y-3">
                <div className="text-sm font-medium text-gray-600">Ações</div>
                <a href={`/relatorio?produtor_id=${produtor.id}`} className="w-full flex items-center gap-3 py-2 border-b text-sm">
